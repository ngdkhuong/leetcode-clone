...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem, _solved }) => {
        ...
        await runTransaction(firestore, async (transaction) => {
            ...
            if (userDoc.exists() && problemDoc.exists()) {
                if (liked) {
                    ...
                    setData((prev: any) => ({ ...prev, liked: false }));
                } else if (disliked) {
                    transaction.update(userRef, {
                    ...
                    setData((prev: any) => ({ ...prev, liked: true, disliked: false }));
                } else {
                    transaction.update(userRef, {
                        likedProblems: [...userDoc.data().likedProblems, problem.id],
                    });
                    ...
                    setData((prev: any) => ({ ...prev, liked: true }));
                }
            }
        });
        ...
        await runTransaction(firestore, async (transaction) => {
            ...
            if (userDoc.exists() && problemDoc.exists()) {
                if (disliked) {
                    ...
                    setData((prev: any) => ({ ...prev, disliked: false }));
                } else if (liked) {
                    // just chose like or dislike
                    transaction.update(userRef, {
                    ...
                    setData((prev: any) => ({ ...prev, disliked: true, liked: false }));
                } else {
                    transaction.update(userRef, {
                        dislikedProblems: [...userDoc.data().dislikedProblems, problem.id],
                    });
                    ...
                    setData((prev: any) => ({ ...prev, disliked: true }));
                }
            }
        });
    ...
    const handleStar = async () => {
        ...
        if (!starred) {
            ...
            setData((prev: any) => ({ ...prev, starred: true }));
        } else {
            const userRef = doc(firestore, 'users', user.uid);
            ...
            setData((prev: any) => ({ ...prev, starred: false }));
        }
